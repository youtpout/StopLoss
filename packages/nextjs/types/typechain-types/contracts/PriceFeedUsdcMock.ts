...
export interface PriceFeedUsdcMockInterface extends utils.Interface {
  functions: {
...
export interface PriceFeedUsdcMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceFeedUsdcMockInterface;
