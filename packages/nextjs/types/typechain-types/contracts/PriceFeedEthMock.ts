...
export interface PriceFeedEthMockInterface extends utils.Interface {
  functions: {
...
export interface PriceFeedEthMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceFeedEthMockInterface;
